...
2. Near-zero natural rainfall → vines would suffer severe drought stress without intervention (poor canopy, unripe fruit, stuck ripening)
...
## Likely exam angles
**"Explain why irrigation is necessary in Mendoza and how it can be used to affect wine quality."**
→ Two-part answer required: (1) climate necessity, (2) quality control tool.

Practice answer (template-based):
> "Mendoza sits in the rain shadow of the Andes, receiving only around 200mm of rainfall per year, which is insufficient for vine growth. This means irrigation using Andean snowmelt is essential for survival. Because rainfall is minimal, growers can precisely control water application through deficit irrigation, withholding water at key growth stages to concentrate flavour and reduce berry size, resulting in more concentrated, higher-quality fruit than would occur under natural rainfall alone."
