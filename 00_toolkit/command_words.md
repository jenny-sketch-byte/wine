...
- **Describe** Chablis soil → "Chablis has Kimmeridgian limestone and clay soil with marine fossils."
- **Explain** how Chablis soil affects the wine → "The limestone retains water and reflects sunlight, while the clay provides moderate drainage; this combination contributes to high acidity and a mineral character in the wine."

**Rule of thumb:** if the question says "explain," your answer needs a *because* or *this means that* somewhere in it. If it doesn't, you've only described.

## Practice check
Before writing any answer, underline the command word first. Ask yourself: "Am I about to state a fact, or build a cause-effect chain?" Match your answer shape to that.
