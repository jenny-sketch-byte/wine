...
| Factor | Effect |
|---|---|
| **Latitude** | Lower latitude = more direct sun, warmer. Viable wine belt roughly 30–50° N/S. |
| **Altitude** | Temperature drops ~0.6°C per 100m. High-altitude sites in warm/hot latitudes (Mendoza, Ethiopia) recover cool-climate characteristics. |
| **Proximity to water (ocean/lake)** | Water moderates temperature (slow to heat, slow to cool) → smaller diurnal range, longer growing season, reduced frost risk. |
| **Ocean currents** | Cold currents (Benguela off South Africa, Humboldt off Chile) cool adjacent coastal regions well below their latitude's expected temperature. |
| **Wind** | Cooling effect; can also reduce disease pressure by drying canopy (e.g. Mistral in the Rhône) or increase risk of vine stress if constant/strong. |
| **Mountains / rain shadow** | Block prevailing moisture-bearing winds, creating a dry zone on the leeward side (Alsace/Vosges, Mendoza/Andes). |

## Climate classification (know these terms cold)
- **Maritime**: ocean-moderated, narrow annual temperature range, rainfall spread through the year, higher vintage variation risk (rain at harvest). E.g. Bordeaux, Loire.
- **Continental**: land-locked, wide annual temperature range (hot summers, cold winters), more settled/predictable summers. E.g. Burgundy, Mendoza.
- **Mediterranean**: warm/hot, dry summers, mild wet winters, low vintage variation. E.g. southern Rhône, much of Spain.

## Mesoclimate / topoclimate (site-level modifiers)
- **Aspect**: slope direction relative to the sun. South-facing (N hemisphere) = more direct sun, warmer. Key in marginal cool climates (Burgundy, Mosel).
...
## Vintage variation
- Driven mainly by weather variability at flowering (poor fruit set), during ripening (heat/drought or lack of sun), and at harvest (rain diluting/rotting fruit).
